...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>Tecnoaprender</title>
		...
		<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popp	er.min.js"></script>	
...
<body>
	...
	<button class="btn btn-acerca-de btn-default">Acerca de</button> -->
	<!-- </div> -->
	...
	<div class="cd-user-modal"> <!-- this is the entire modal form, including the background -->
			...
			<div id="cd-login"> <!-- log in form -->
				<form id= "form-login" class="cd-form">
					...
					<p class="fieldset">
						...
						<input class="full-width has-padding has-border" id="signin-password" name="signin_password" type="text"  placeholder="Contraseña">
		...
		<div id="cd-acercade"> 
			<form id= "form-acercade" class="cd-form">
				<p class="fieldset"> Ministerio de Educación Pública de Costa Rica <br>
					Dirección de Recursos Tecnológicos - Depto. Gestión y Producción GESPRO <br>
