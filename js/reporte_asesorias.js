   ...
   fetch( url)
    ...
    function dibujarTabla (array, visor) {
     ...
     function exportPDF() {
      ...
      //--Se define la posición de la hoja y tamaño de la misma//
      //var doc = new jsPDF('portrait', 'pt', 'letter', true);
      var doc = new jsPDF();
      var elementHTML = $('#datos_visita').html();
      //var elementHTML = document.getElementById("datos_visita");
      ...
      //doc.text(20, 80, 'Gestión educativa');
      //doc.addImage(imgData, 'JPEG', 28, 22, 28, 16);

      //doc.text(20, 100, 'This is client-side Javascript to generate a PDF.');

      // Save the PDF
        doc.save('Gestión educativa.pdf');
     }