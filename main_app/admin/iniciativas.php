    ...
    <div class="col-sm-12">
      <div class="">
        <div class="d-flex flex-row">
          ...
          <div class="p-2 align-self-center"><span class="tit-header-opt">Iniciativas y proyectos</span></div>
      ...
      <div class="modal-dialog">  
           <div class="modal-content">  
                <div class="modal-header">  
                     ...
                     <h4 class="modal-title">Iniciativas</h4>  
                </div>  
                <div class="modal-body" id="employee_detail">  
                    <label for="nombre">Iniciativa:</label>
    ...
    <br>
            <?php
                if ($_SESSION["tipo_usuario"]  != "6"  ) {
                    echo "<h3 id='agregarIniciativa'><i class='fa fa-plus-square' style='font-size:24px'></i> Agregar iniciativa</h3>";
                }
            ?>
            <div id="visor">
