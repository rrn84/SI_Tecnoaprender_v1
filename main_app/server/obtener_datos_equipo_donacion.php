...
$sql= "SELECT 
equipamiento_donacion.requiere_soporte, equipamiento_donacion.donacion_estado
FROM equipamiento_donacion
INNER JOIN centro_educativo ON  centro_educativo.id=equipamiento_donacion.id_CE 
