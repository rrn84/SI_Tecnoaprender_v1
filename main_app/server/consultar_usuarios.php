<?php
$sql= "SELECT usuarios.id_tipo, usuarios.id,usuarios.nombre, tipo_funcionario.descripcion, usuarios.correo, usuarios.last_session, usuarios.telefono_movil FROM usuarios INNER JOIN tipo_funcionario ON usuarios.id_tipo=tipo_funcionario.id_tipo";
