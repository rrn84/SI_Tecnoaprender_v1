...
$sql= "SELECT 
equipamiento_transferencia.requiere_soporte, equipamiento_transferencia.transferencia_estado
FROM equipamiento_transferencia
INNER JOIN centro_educativo ON  centro_educativo.id=equipamiento_transferencia.id_CE 
