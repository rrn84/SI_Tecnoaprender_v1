<?php
$cod_cap= $_GET['codigo'];
$sql= "SELECT capacitaciones_participantes.cedula, centro_educativo.institucion FROM capacitaciones_participantes INNER JOIN centro_educativo ON centro_educativo.id = capacitaciones_participantes.id_CE  WHERE cod_cap='$cod_cap'";
