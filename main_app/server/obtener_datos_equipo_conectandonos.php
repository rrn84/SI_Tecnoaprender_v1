...
$sql= "SELECT 
equipamiento_conectandonos.requiere_soporte, equipamiento_conectandonos.conectandonos_estado
FROM equipamiento_conectandonos
INNER JOIN centro_educativo ON  centro_educativo.id=equipamiento_conectandonos.id_CE 
