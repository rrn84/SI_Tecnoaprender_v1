...
$cual= "centro_educativo";
$sql = "SELECT proyectos.id_CE, iniciativas.nombre  FROM proyectos INNER JOIN iniciativas ON iniciativas.id=proyectos.id_iniciativa WHERE `id_CE`='$quien'";
